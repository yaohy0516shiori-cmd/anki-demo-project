...
CREATE TABLE IF NOT EXISTS review_log (
    id INTEGER PRIMARY KEY AUTOINCREMENT, -- log_id
    ...
    new_status TEXT NOT NULL CHECK(new_status IN ('new', 'learning', 'review','relearn')),
    ...
    old_step_index INTEGER NOT NULL,
    new_step_index INTEGER NOT NULL,
